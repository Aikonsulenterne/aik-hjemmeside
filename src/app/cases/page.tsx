...
const cases = [
  ...
  },
  {
    ...
    results: ["Halveret rapporteringstid", "Bedre datakvalitet"],
    quote: null,
  },
  {
    company: "INDKOM",
    ...
    results: ["Hurtigere onboarding", "Mindre tid brugt på søgning"],
    quote: null,
  },
  {
    company: "J.M Band",
    ...
    results: ["Fuldt dataoverblik", "Bedre beslutningsgrundlag"],
    quote: null,
  },
];
      ...
      <section className="pb-[clamp(3rem,8vw,6rem)]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col gap-8">
            {cases.map((c, i) => (
              <FadeIn key={c.company} delay={i * 100}>
