...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Viden om AI \u2014 blog-artikler';
  ...
  attributes: {
    author: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'AI Konsulenterne'>;
...
export interface ApiCaseCase extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Kundecases \u2014 konkrete AI-projekter hos AIK's kunder";
    displayName: 'Case';
    pluralName: 'cases';
    singularName: 'case';
  };
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['intern-ai', 'webshop', 'vidensbase', 'hr', 'andet']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'intern-ai'>;
    challenge: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer: Schema.Attribute.String & Schema.Attribute.Required;
    customerLogo: Schema.Attribute.Media<'images'>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    result: Schema.Attribute.RichText & Schema.Attribute.Required;
    seoDescription: Schema.Attribute.Text;
    seoTitle: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Holdet bag AI Konsulenterne';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Kunde-citater og anbefalinger';
